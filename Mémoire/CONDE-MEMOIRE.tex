...
\usepackage{pdflscape}  % dans le préambule
...
\begin{center}
    ...
    \Large Mastère Expert en Systèmes d’Information\\[1em]
...
\subsection{Le site de Carquefou}

Situé près de Nantes, le site de Carquefou est un des pôles clés de l’entreprise. Il concentre les activités liées à la maintenance lourde, aux expertises techniques (électriques et mécaniques), et à la rénovation des équipements tournants. Ce site est particulièrement reconnu pour :
\begin{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{../Images/app-si.png}
...
\\
Plus encore, elles illustrent un modèle de numérisation à échelle humaine, où c’est l’outil qui s’adapte à l’utilisateur au lieu de l’inverse. Principe de co-construction et clé du succès des projets de transformation numérique à l’échelle industrielle.
...
Face à ces constats récurrents, la direction du site de Carquefou a initié une réflexion sur la modernisation des outils internes. Plutôt que d’adopter un progiciel lourd ou un ERP global, l’entreprise a fait le choix stratégique de développer des \textbf{applications web sur mesure}. Ce choix repose sur plusieurs critères :
...
\item \textbf{TraQbar (traçabilité des barres)}
...
\subsubsection{Illustration des interfaces applicatives}

Pour mieux illustrer le travail accompli durant la mission, un choix d’interfaces utilisateurs a été annexé. En effet, les captures d’écran proposées permettent de visualiser dans la pratique le résultat obtenu au terme des développements opérationnels réalisés, tant en termes d’ergonomie que de fonctionnalités. Celles-ci se doivent donc de venir en soutien à notre propre présentation, la mise en perspective visuelle des choix techniques que nous avons opéré en matière de navigation, de structuration de l’information et de confort d’utilisation, permettant in fine de mieux expliciter la pertinence du giron conceptuel au regard des résultats escomptés.

Toutefois, compte tenu du nombre de projets développés au cours de cette alternance, trois applications complètes, chacune avec ses modules, ses workflows et ses spécificités.Il n’était ni pertinent ni lisible d’inclure l’intégralité des interfaces produites. Une documentation exhaustive aurait conduit à une surcharge visuelle et allongé considérablement le volume du document.

C’est dans cette logique de clarté et de concision, il a été décidé de focaliser cette présentation visuelle autour de l’application \textbf{TraQbar}, désignée comme la plus représentative en termes de complexité, richesse fonctionnelle, interaction avec l’utilisateur. Les interfaces choisies englobent différentes facettes : tableau de suivi de production, déclaration de non-conformité, visualisation du parcours d’une barre, modules de supervision. Ce choix n’enlève rien à la qualité ou à l’importance des deux autres applications, mais vise à donner au lecteur une compréhension concrète du type d’outils livrés, sans alourdir inutilement le mémoire. Les autres interfaces restent disponibles sur demande ou peuvent faire l’objet d’un support dédié en annexe technique complémentaire.
...
\section*{Annexes}
\begin{enumerate}
\item \textbf{Product Backlog de la base d'expertise}
...
\newpage
\item \textbf{Product Backlog de TraQbar}
\begin{table}[H]
\centering
...
\hline
US-22 & Gestion mise caisse & En tant que production, je peux gérer la mise en caisse. & 3 \\
\hline
US-23 & Suivre le stock & En tant qu’utilisateur, je peux suivre le stock des tourets. & 4 \\
\hline
US-24 & Suivre les barres & En tant qu’utilisateur, je peux suivre toutes les barres d'une affaire. & 4 \\
\hline
US-25 & Suivre une barre  & En tant qu’utilisateur, je peux suivre les informations d'une barre. & 4 \\
\hline
US-26 & Suivre production & En tant qu’utilisateur, je peux suivre les productions d'une affaire. & 4 \\
\hline
US-27 & Suivre production journalier & En tant qu’utilisateur, je peux suivre la production journiliere d'une affaire. & 4 \\
\hline
US-28 & Suivre l'historique des barres & En tant qu’utilisateur, je peux suivre l'historique des barres. & 4 \\
\hline
US-29 & Suivre l'historique pas contrôle & En tant qu’utilisateur, je peux suivre l'historique de pas contrôle d'une barre. & 4 \\
\hline
US-30 & Suivre l'historique fausse tôlerie & En tant qu’utilisateur, je peux suivre l'historique des fausses tôlerie d'une barre. & 4 \\
\hline
US-31 & Suivre les contrôles électrique des barres & En tant qu’utilisateur, je peux suivre les contrôles ECE des barres. & 4 \\

\hline
US-32 & Suivre l'historique fausse tôlerie & En tant qu’utilisateur, je peux suivre l'historique des fausses tôlerie d'une barre. & 4 \\
\hline
\end{tabular}
...
\textbf{ID} & \textbf{Cas d’utilisation} & \textbf{User Story} & \textbf{Priorité} \\
\hline
US-33 & Gestion rebuts & En tant que superviseur, je peux gérer les rebuts. & 5 \\
\hline
US-34 & Gestion barres pré-série et réglage & En tant que technicien, je peux gérer les barres de présérie et le réglage. & 5 \\
\hline
US-35 & Gestion réunions & En tant que superviseur, je peux gérer les réunions. & 5 \\
\hline
US-36 & Gestion historique des tables & En tant que superviseur, je peux consulter l’historique des tables. & 5 \\
\hline
US-37 & Gestion impressions pdf/excel & En tant qu’utilisateur, je peux générer et imprimer les rapports. & 5 \\
\hline
\end{tabular}
\caption{Product Backlog  3 – Application Suivi Budget Maintenance }
\end{table}

\newpage
\item \textbf{Product Backlog de Suivi Budget Maintenance}
\begin{table}[H]
\centering
\begin{tabular}{|c|p{5cm}|p{7cm}|c|}
\hline
\textbf{ID} & \textbf{Cas d’utilisation} & \textbf{User Story} & \textbf{Priorité} \\
\hline
US-01 & S’authentifier & En tant qu’utilisateur, je peux m’authentifier pour accéder aux fonctionnalités de l’application. & 1 \\
\hline
US-02 & Gérer Utilisateur & En tant qu’admin, je peux gérer les comptes utilisateurs. & 1 \\
\hline
US-03 & Gérer Articles & En tant qu’admin, je peux gérer les articles pour les dépenses. & 1 \\
\hline
US-04 & Gérer réceptionniste & En tant qu’admin, je peux ajouter ou modifier les réceptionnistes. & 1 \\
\hline
US-05 & Gérer investissement & En tant qu’admin, je peux gérer les investissements de l’organisation. & 1 \\
\hline
US-06 & Gérer dépense investissement & En tant qu’admin, je peux gérer les dépenses liées aux investissements. & 1 \\
\hline	
US-07 & Gérer dépense & En tant qu’admin, je peux saisir et suivre toutes les dépenses. & 1 \\
\hline
US-08 & Exporter en PDF & En tant qu’utilisateur, je peux exporter les données de dépense en PDF. & 2 \\
\hline
US-09 & Exporter en Excel & En tant qu’utilisateur, je peux exporter les données de dépense en Excel. & 2 \\
\hline
US-10 & Gérer budget & En tant que superviseur, je peux définir et ajuster le budget. & 2 \\
\hline
US-11 & Voir Historique & En tant que superviseur, je peux consulter l’historique des dépenses et budgets. & 2 \\
\hline
US-12 & Gérer filtre & En tant que superviseur, je peux filtrer les dépenses selon différents critères. & 2 \\
\hline
\end{tabular}
\caption{Product Backlog – Application Suivi Budget Maintenance}
\end{table}

\newpage
\item \textbf{Quelques Interfaces de l'application TraQbar }
\begin{table}[H]
\centering
\renewcommand{\arraystretch}{1}
\begin{tabular}{|p{8cm}|p{8cm}|}
\hline
S’authentifier & Tableau de bord \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/auth.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/tableau-bord.png} \tabularnewline
\hline
Liste Admins & Ajouter un admin \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/listes utilisateurs.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/ajouter utilisateur.png} \tabularnewline
\hline
Liste des affaires & Ajouter une affaire \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/affaire-list.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/affaire-add.png} \tabularnewline
\hline
Accueil Production & Affaire existante \tabularnewline
\hline
\centering\includegraphics[width=0.9\linewidth]{../IMGS/prod-acc.png} &
\centering\includegraphics[width=0.9\linewidth]{../IMGS/page_affaire.png} \tabularnewline
\hline
\end{tabular}
\caption{Quelques Interfaces de l’application TraQbar}
\end{table}
...
\begin{tabular}{|p{8cm}|p{8cm}|}
\hline
Accueil Production d'une affaire & Accueil Logistique \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/index production.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/Accueil-logist&Sup.png} \tabularnewline
\hline
Table technique & Table Process \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/table technique 1.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/table-process-1.png} \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/table technique 2.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/table-process-2.png} \tabularnewline
\hline
Accueil Production par poste & Page de Configuration \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/acc-prod-poste.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/config.png} \tabularnewline
\hline
Poste - Débit et tressage & Ajout de touret  \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/debit-barre-encours.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/touret-add.png} \tabularnewline
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{8cm}|p{8cm}|}
\hline
Opération de production en cours au poste débit & Confirmation de l'état de la barre \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/page d'operation.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/section confirmation.png} \tabularnewline
\hline
Barre non  conforme - choix de la cause & Section déclaration d'une panne \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/section confiramtion de non-conforme.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/section panne.png} \tabularnewline
\hline
Poste - Presse agglommération CALIBRE MIN ET MAX  & Page de validation des barres \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/poste agglommération calibre min et max.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/poste agglo-confirmation des barres.png} \tabularnewline
\hline
Poste - Déshydratation des barres  & Page de validation des barres en déshydratation \tabularnewline
\hline\centering\includegraphics[width=1\linewidth]{../IMGS/deshydratation.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/valider_deshydration.png} \tabularnewline
\hline

Confirmation des barres en cours de déshydratation  & Valider une seule barre en cours déshydratation \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/valider_toutes_les_barres_deshy.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/valider_une_seule_barre_deshy.png} \tabularnewline
\hline
...
\begin{tabular}{|p{8cm}|p{8cm}|}
\hline
Poste -  Essais Electrique, partie Tangente, saisie une barre & Remplir les informations ECE de la barre \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/elec-tang-acc.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/elec-tang-delta.png} \tabularnewline
\hline

Supervision, suivi stock & Supervision, suivi stock \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi stock 1.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi stock 2.png} \tabularnewline
\hline
Supervision, suivi d'une barre & Supervision, suivi des barres \tabularnewline
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi-une-barre.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi-barres.png} \tabularnewline

\centering\includegraphics[width=1\linewidth]{../IMGS/suivi d'une barre 2.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi des barres 2.png} \tabularnewline
\hline
Supervision, suivi production journalier & Supervision, suivi production globale \tabularnewline

\centering\includegraphics[width=1\linewidth]{../IMGS/suivi-journalier.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/suivi-production.png} \tabularnewline
\hline
\end{tabular}
\end{table}
...
\begin{tabular}{|p{8cm}|p{8cm}|}
\hline
Supervision -  Statistique des barres & Statistique des barres \tabularnewline
\centering\includegraphics[width=1\linewidth]{../IMGS/state-1.png} 
	&
\centering\includegraphics[width=1\linewidth]{../IMGS/state-2.png} \tabularnewline

\centering\includegraphics[width=1\linewidth]{../IMGS/Super-3.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/Super-4.png} \tabularnewline
\hline
Logistique -  Approvisionnement des tourets & Les barres déclarées non-conforme (malfaçon) \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/Logistique.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/malf.png} \tabularnewline
\hline
Ajout d'une caisse & Mise en caisse des barres \tabularnewline
\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/mise en caisse.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/ajouter_une_barre_dans_une_caisse.png} \tabularnewline

\hline
\centering\includegraphics[width=1\linewidth]{../IMGS/ajout d'une nouvelle caisse.png} &
\centering\includegraphics[width=1\linewidth]{../IMGS/impre-caisse.png}
 \tabularnewline
\hline
\end{tabular}
\end{table}
